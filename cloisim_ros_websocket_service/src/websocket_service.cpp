    ...
    , is_connected_(false)
{
  ...
  client_.set_open_handler(bind(&WebSocketService::on_open, this, placeholders::_1));
  client_.set_close_handler(bind(&WebSocketService::on_close, this, placeholders::_1));
  client_.set_message_handler(bind(&WebSocketService::on_message, this, placeholders::_1, placeholders::_2));
