...
void GroundTruth::Initialize()
{
  ...
  if (data_bridge_ptr != nullptr) {
    ...
    AddBridgeReceiveWorker(
      data_bridge_ptr, bind(&GroundTruth::PublishData, this, std::placeholders::_1, std::placeholders::_2));
  }
}

void GroundTruth::PublishData(const void* buffer, int bufferLength)
{
